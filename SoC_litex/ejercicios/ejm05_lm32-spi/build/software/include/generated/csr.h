//--------------------------------------------------------------------------------
// Auto-generated by Migen (54d666d) & LiteX (f2570701) on 2019-06-18 15:03:42
//--------------------------------------------------------------------------------
...
/* ctrllcd */
#define CSR_CTRLLCD_BASE 0xe0002000L
#define CSR_CTRLLCD_OUT_ADDR 0xe0002000L
#define CSR_CTRLLCD_OUT_SIZE 1
static inline unsigned int ctrllcd_out_read(void) {
	unsigned int r = csr_readl(0xe0002000L);
	return r;
}
static inline void ctrllcd_out_write(unsigned int value) {
...
/* spi */
#define CSR_SPI_BASE 0xe0001800L
#define CSR_SPI_CONFIG_ADDR 0xe0001800L
#define CSR_SPI_CONFIG_SIZE 1
...
#define CSR_SPI_XFER_ADDR 0xe0001804L
#define CSR_SPI_XFER_SIZE 1
...
#define CSR_SPI_START_ADDR 0xe0001808L
#define CSR_SPI_START_SIZE 1
static inline unsigned int spi_start_read(void) {
	unsigned int r = csr_readl(0xe0001808L);
	return r;
}
static inline void spi_start_write(unsigned int value) {
	csr_writel(value, 0xe0001808L);
}
#define CSR_SPI_ACTIVE_ADDR 0xe000180cL
#define CSR_SPI_ACTIVE_SIZE 1
static inline unsigned int spi_active_read(void) {
	unsigned int r = csr_readl(0xe000180cL);
	return r;
}
#define CSR_SPI_PENDING_ADDR 0xe0001810L
#define CSR_SPI_PENDING_SIZE 1
static inline unsigned int spi_pending_read(void) {
	unsigned int r = csr_readl(0xe0001810L);
	return r;
}
#define CSR_SPI_MOSI_DATA_ADDR 0xe0001814L
#define CSR_SPI_MOSI_DATA_SIZE 1
...
#define CSR_SPI_MISO_DATA_ADDR 0xe0001818L
#define CSR_SPI_MISO_DATA_SIZE 1
...
/* timer0 */
#define CSR_TIMER0_BASE 0xe0004000L
#define CSR_TIMER0_LOAD_ADDR 0xe0004000L
#define CSR_TIMER0_LOAD_SIZE 1
static inline unsigned int timer0_load_read(void) {
	unsigned int r = csr_readl(0xe0004000L);
	return r;
}
static inline void timer0_load_write(unsigned int value) {
	csr_writel(value, 0xe0004000L);
}
#define CSR_TIMER0_RELOAD_ADDR 0xe0004004L
#define CSR_TIMER0_RELOAD_SIZE 1
static inline unsigned int timer0_reload_read(void) {
	unsigned int r = csr_readl(0xe0004004L);
	return r;
}
static inline void timer0_reload_write(unsigned int value) {
	csr_writel(value, 0xe0004004L);
}
#define CSR_TIMER0_EN_ADDR 0xe0004008L
#define CSR_TIMER0_EN_SIZE 1
static inline unsigned int timer0_en_read(void) {
	unsigned int r = csr_readl(0xe0004008L);
	return r;
}
static inline void timer0_en_write(unsigned int value) {
	csr_writel(value, 0xe0004008L);
}
#define CSR_TIMER0_UPDATE_VALUE_ADDR 0xe000400cL
#define CSR_TIMER0_UPDATE_VALUE_SIZE 1
static inline unsigned int timer0_update_value_read(void) {
	unsigned int r = csr_readl(0xe000400cL);
	return r;
}
static inline void timer0_update_value_write(unsigned int value) {
	csr_writel(value, 0xe000400cL);
}
#define CSR_TIMER0_VALUE_ADDR 0xe0004010L
#define CSR_TIMER0_VALUE_SIZE 1
static inline unsigned int timer0_value_read(void) {
	unsigned int r = csr_readl(0xe0004010L);
	return r;
}
#define CSR_TIMER0_EV_STATUS_ADDR 0xe0004014L
#define CSR_TIMER0_EV_STATUS_SIZE 1
static inline unsigned int timer0_ev_status_read(void) {
	unsigned int r = csr_readl(0xe0004014L);
	return r;
}
static inline void timer0_ev_status_write(unsigned int value) {
	csr_writel(value, 0xe0004014L);
}
#define CSR_TIMER0_EV_PENDING_ADDR 0xe0004018L
...
static inline void timer0_ev_pending_write(unsigned int value) {
	csr_writel(value, 0xe0004018L);
}
#define CSR_TIMER0_EV_ENABLE_ADDR 0xe000401cL
#define CSR_TIMER0_EV_ENABLE_SIZE 1
static inline unsigned int timer0_ev_enable_read(void) {
	unsigned int r = csr_readl(0xe000401cL);
	return r;
}
...
/* uart */
#define CSR_UART_BASE 0xe0003000L
#define CSR_UART_RXTX_ADDR 0xe0003000L
...
#define CSR_UART_EV_PENDING_ADDR 0xe0003010L
...
#define CSR_UART_EV_ENABLE_ADDR 0xe0003014L
...
/* uart_phy */
#define CSR_UART_PHY_BASE 0xe0002800L
#define CSR_UART_PHY_TUNING_WORD_ADDR 0xe0002800L
...
/* identifier_mem */
#define CSR_IDENTIFIER_MEM_BASE 0xe0003800L
