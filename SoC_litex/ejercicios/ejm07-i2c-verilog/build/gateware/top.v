//--------------------------------------------------------------------------------
// Auto-generated by Migen (54d666d) & LiteX (f2570701) on 2019-07-14 21:30:52
//--------------------------------------------------------------------------------
module top(
...
reg int_rst = 1'd1;
reg rst = 1'd0;
reg [15:0] prescale_storage_full = 16'd0;
wire [15:0] prescale_storage;
reg prescale_re = 1'd0;
reg [7:0] control_storage_full = 8'd0;
wire [7:0] control_storage;
reg control_re = 1'd0;
reg [7:0] transmit_storage_full = 8'd0;
wire [7:0] transmit_storage;
reg transmit_re = 1'd0;
reg [7:0] receive_storage_full = 8'd0;
wire [7:0] receive_storage;
reg receive_re = 1'd0;
reg [7:0] command_storage_full = 8'd0;
wire [7:0] command_storage;
reg command_re = 1'd0;
reg [7:0] status_storage_full = 8'd0;
wire [7:0] status_storage;
reg status_re = 1'd0;
...
wire [15:0] csrbank1_prescale0_r;
wire [15:0] csrbank1_prescale0_w;
wire csrbank1_control0_re;
wire [7:0] csrbank1_control0_r;
wire [7:0] csrbank1_control0_w;
wire csrbank1_transmit0_re;
wire [7:0] csrbank1_transmit0_r;
wire [7:0] csrbank1_transmit0_w;
wire csrbank1_receive0_re;
wire [7:0] csrbank1_receive0_r;
wire [7:0] csrbank1_receive0_w;
wire csrbank1_command0_re;
wire [7:0] csrbank1_command0_r;
wire [7:0] csrbank1_command0_w;
wire csrbank1_status0_re;
wire [7:0] csrbank1_status0_r;
wire [7:0] csrbank1_status0_w;
wire csrbank1_sel;
...
assign csrbank1_prescale0_r = interface1_bank_bus_dat_w[15:0];
assign csrbank1_prescale0_re = ((csrbank1_sel & interface1_bank_bus_we) & (interface1_bank_bus_adr[2:0] == 1'd0));
assign csrbank1_control0_r = interface1_bank_bus_dat_w[7:0];
assign csrbank1_control0_re = ((csrbank1_sel & interface1_bank_bus_we) & (interface1_bank_bus_adr[2:0] == 1'd1));
assign csrbank1_transmit0_r = interface1_bank_bus_dat_w[7:0];
assign csrbank1_transmit0_re = ((csrbank1_sel & interface1_bank_bus_we) & (interface1_bank_bus_adr[2:0] == 2'd2));
assign csrbank1_receive0_r = interface1_bank_bus_dat_w[7:0];
assign csrbank1_receive0_re = ((csrbank1_sel & interface1_bank_bus_we) & (interface1_bank_bus_adr[2:0] == 2'd3));
assign csrbank1_command0_r = interface1_bank_bus_dat_w[7:0];
assign csrbank1_command0_re = ((csrbank1_sel & interface1_bank_bus_we) & (interface1_bank_bus_adr[2:0] == 3'd4));
assign csrbank1_status0_r = interface1_bank_bus_dat_w[7:0];
assign csrbank1_status0_re = ((csrbank1_sel & interface1_bank_bus_we) & (interface1_bank_bus_adr[2:0] == 3'd5));
assign prescale_storage = prescale_storage_full[15:0];
assign csrbank1_prescale0_w = prescale_storage_full[15:0];
assign control_storage = control_storage_full[7:0];
assign csrbank1_control0_w = control_storage_full[7:0];
assign transmit_storage = transmit_storage_full[7:0];
assign csrbank1_transmit0_w = transmit_storage_full[7:0];
assign receive_storage = receive_storage_full[7:0];
assign csrbank1_receive0_w = receive_storage_full[7:0];
assign command_storage = command_storage_full[7:0];
assign csrbank1_command0_w = command_storage_full[7:0];
assign status_storage = status_storage_full[7:0];
assign csrbank1_status0_w = status_storage_full[7:0];
assign sel = (sram_bus_adr1[13:9] == 3'd6);
always @(*) begin
...
always @(posedge sys_clk) begin
	...
	if (csrbank1_sel) begin
		case (interface1_bank_bus_adr[2:0])
			1'd0: begin
				interface1_bank_bus_dat_r <= csrbank1_prescale0_w;
			end
			1'd1: begin
				interface1_bank_bus_dat_r <= csrbank1_control0_w;
			end
			2'd2: begin
				interface1_bank_bus_dat_r <= csrbank1_transmit0_w;
			end
			2'd3: begin
				interface1_bank_bus_dat_r <= csrbank1_receive0_w;
			end
			3'd4: begin
				interface1_bank_bus_dat_r <= csrbank1_command0_w;
			end
			3'd5: begin
				interface1_bank_bus_dat_r <= csrbank1_status0_w;
			end
		endcase
	end
	if (csrbank1_prescale0_re) begin
		prescale_storage_full[15:0] <= csrbank1_prescale0_r;
	end
	prescale_re <= csrbank1_prescale0_re;
	if (csrbank1_control0_re) begin
		control_storage_full[7:0] <= csrbank1_control0_r;
	end
	control_re <= csrbank1_control0_re;
	if (csrbank1_transmit0_re) begin
		transmit_storage_full[7:0] <= csrbank1_transmit0_r;
	end
	transmit_re <= csrbank1_transmit0_re;
	if (csrbank1_receive0_re) begin
		receive_storage_full[7:0] <= csrbank1_receive0_r;
	end
	receive_re <= csrbank1_receive0_re;
	if (csrbank1_command0_re) begin
		command_storage_full[7:0] <= csrbank1_command0_r;
	end
	command_re <= csrbank1_command0_re;
	if (csrbank1_status0_re) begin
		status_storage_full[7:0] <= csrbank1_status0_r;
	end
	status_re <= csrbank1_status0_re;
	sel_r <= sel;
	...
	if (sys_rst) begin
		...
		timer0_value <= 32'd0;
		prescale_storage_full <= 16'd0;
		prescale_re <= 1'd0;
		control_storage_full <= 8'd0;
		control_re <= 1'd0;
		transmit_storage_full <= 8'd0;
		transmit_re <= 1'd0;
		receive_storage_full <= 8'd0;
		receive_re <= 1'd0;
		command_storage_full <= 8'd0;
		command_re <= 1'd0;
		status_storage_full <= 8'd0;
		status_re <= 1'd0;
		grant <= 1'd0;
		slave_sel_r <= 4'd0;
		count <= 20'd1000000;
...
i2c i2c(
	...
	.prescale(prescale_storage),
	.transmit(transmit_storage),
	.scl(i2c_master_scl),
	.sda(i2c_master_sda),
